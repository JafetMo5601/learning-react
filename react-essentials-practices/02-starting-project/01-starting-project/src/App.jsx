...
function App() {
  ...
  let content = <SelectedProject tasks={projectState.tasks} onDelete={handleDeleteProject} project={selectedProject} onAddTask={handleAddTask} onDeleteTask={handleDeleteTask}/>;
